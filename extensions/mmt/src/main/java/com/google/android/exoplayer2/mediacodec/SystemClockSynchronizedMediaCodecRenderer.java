 ...
 */
public abstract class SystemClockSynchronizedMediaCodecRenderer extends BaseRenderer {
   ...
   */
  public SystemClockSynchronizedMediaCodecRenderer(
      int trackType,
      ...
      if (codec != null) {
        ...
        try {
          codec.stop();
            ...
            //jjustman-2020-10-13 - patch around for illegalStateException which causes ExoPlayerImplInternal: Reset failed.
            Log.e("MediaCodec:releaseCodec", "stop threw exception, ignoring: ex: "+ex.getMessage());
            throw ex;
        } finally {
          codec.release();
        }
  ...
  private boolean feedInputBuffer() throws ExoPlaybackException {
    ...
    try {
      ...
      Log.d("MediaCodecRenderer", String.format("feedInputBuffer: largestQueuedPresentationTimeUs: %d, max(largestQueuedPresentationTimeUs: %d, presentationTimeUs: %d", largestQueuedPresentationTimeUs, largestQueuedPresentationTimeUs, presentationTimeUs));
  ...
  private boolean drainOutputBuffer(long positionUs, long elapsedRealtimeUs)
    ...
    Log.i("MediaCodecRenderer",String.format("JJ: drainOutputBuffer, outputBufferInfo.presentationTimeUs: %d, codec: %s", outputBufferInfo.presentationTimeUs, codec.getName()));
