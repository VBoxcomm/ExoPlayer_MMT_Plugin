...
import com.google.android.exoplayer2.mediacodec.SystemClockSynchronizedMediaCodecRenderer;
 ...
 * </ul>
 */
public class SystemClockSynchronizedMediaCodecAudioRenderer extends SystemClockSynchronizedMediaCodecRenderer implements MediaClock {
   ...
   */
  public SystemClockSynchronizedMediaCodecAudioRenderer(Context context, MediaCodecSelector mediaCodecSelector) {
    this(
            context,
            mediaCodecSelector,
   ...
   */
  public SystemClockSynchronizedMediaCodecAudioRenderer(
          Context context,
...
//    }
  ...
  private final class AudioSinkListener implements AudioSink.Listener {
    ...
    public void onAudioSessionId(int audioSessionId) {
      ...
      SystemClockSynchronizedMediaCodecAudioRenderer.this.onAudioSessionId(audioSessionId);
    }
    ...
    public void onPositionDiscontinuity() {
      ...
      SystemClockSynchronizedMediaCodecAudioRenderer.this.allowPositionDiscontinuity = true;
    }

    @Override
    public void onUnderrun(int bufferSize, long bufferSizeMs, long elapsedSinceLastFeedMs) {
      Log.w("SystemClockSynchronizedMediaCodecAudioRenderer:AudioSinkListener", String.format("onUnderrun: not notifying callback - bufferSize: %d, bufferSizeMs: %d, elapsedSinceLastFeedMs: %d", bufferSize, bufferSizeMs, elapsedSinceLastFeedMs));
