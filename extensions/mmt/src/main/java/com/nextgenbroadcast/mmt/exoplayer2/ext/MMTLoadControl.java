...
public class MMTLoadControl extends DefaultLoadControl {
    /* jjustman-2020-10-20 -
        ...
        jjustman-2020-12-30: NOTE: minBufferAudio/VideoMs cannot be less than bifferForPlaybackMs
       */
    public MMTLoadControl() {
        super(new DefaultAllocator(true, C.DEFAULT_BUFFER_SEGMENT_SIZE),
                /*minBufferAudioMs*/ 250,

                /*minBufferVideoMs*/ 250,

                /*DEFAULT_MAX_BUFFER_MS*/ 3000,

                /*DEFAULT_BUFFER_FOR_PLAYBACK_MS*/ 100,

                /*DEFAULT_BUFFER_FOR_PLAYBACK_AFTER_REBUFFER_MS*/ 100,

                /*DEFAULT_TARGET_BUFFER_BYTES*/ 16384, //was 1024 bytes?
