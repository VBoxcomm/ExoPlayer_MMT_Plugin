...
//    }
  ...
  private final class AudioSinkListener implements AudioSink.Listener {
    ...
    public void onUnderrun(int bufferSize, long bufferSizeMs, long elapsedSinceLastFeedMs) {
        Log.w("MediaCodecAudioRenderer:AudioSinkListener", String.format("onUnderrun: bufferSize: %d, bufferSizeMs: %d, elapsedSinceLastFeedMs: %d", bufferSize, bufferSizeMs, elapsedSinceLastFeedMs));
