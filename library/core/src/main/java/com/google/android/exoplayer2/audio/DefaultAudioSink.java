...
public final class DefaultAudioSink implements AudioSink {
    ...
    if (inputBuffer == null) {
      ...
      if (startMediaTimeState == START_NOT_SET) {
        ...
        if (startMediaTimeState == START_IN_SYNC
            ...
            Log.e("DefaultAudioSink", "JJ: Discontinuity detected [expected " + expectedPresentationTimeUs + ", got "
              + presentationTimeUs + "] differential: "+(presentationTimeUs - expectedPresentationTimeUs)+"us ("+((presentationTimeUs - expectedPresentationTimeUs)/1000000.0)+"s)");
        ...
        if (startMediaTimeState == START_NEED_SYNC) {
          ...
          startMediaTimeState = START_IN_SYNC;
          Log.e("DefaultAudioSink", String.format("JJ: startMediaTimeState: START_NEED_SYNC startMediaTimeUs: %d (adjustmentUs: %d), listener: %s", startMediaTimeUs, adjustmentUs, listener));
  ...
  public void pause() {
    ...
    if (isInitialized() && audioTrackPositionTracker.pause()) {
      Log.w("DefaultAudioSink","JJ: calling pause()!");
      audioTrack.pause();
    }
  }
  ...
  private final class PositionTrackerListener implements AudioTrackPositionTracker.Listener {
    ...
    public void onUnderrun(int bufferSize, long bufferSizeMs) {
      if (listener != null) {
          ...
          Log.e("DefaultAudioSink", String.format("JJ: onUnderrun: bufferSize: %d, bufferSizeMs: %d, elapsedSinceLastFeedMs: %d - JJ invoking listener.onUnderrun: %s", bufferSize, bufferSizeMs, elapsedSinceLastFeedMs, listener));
