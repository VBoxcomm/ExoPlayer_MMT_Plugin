  ...
  private void doSomeWork() throws ExoPlaybackException, IOException {
    ...
    for (Renderer renderer : enabledRenderers) {
      ...
      if(!rendererReadyOrEnded) {
        Log.d("ExoPlayerImplInternal", String.format("doSomeWork: render.isReady: %b, renderer: %s", renderer.isReady(), renderer));
      }
      if (!rendererReadyOrEnded) {
    ...
    if (renderersEnded
      ...
      setState(Player.STATE_BUFFERING);
      stopRenderers();
      Log.i("ExoPlayerImplInternal", String.format("JJ:calling default setState(Player.STATE_BUFFERING) and stopRenderers!"));
    }
