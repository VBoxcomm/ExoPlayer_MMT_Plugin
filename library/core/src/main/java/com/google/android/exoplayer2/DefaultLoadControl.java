...
public class DefaultLoadControl implements LoadControl {
   ...
   */
  public static final int DEFAULT_MAX_BUFFER_MS = 1000; //50000; //jjustman-2020-08-06 - reduce down to 5 from 50s?

  /**
   * The default duration of media that must be buffered for playback to start or resume following a
   * user action such as a seek, in milliseconds.
   */
  public static final int DEFAULT_BUFFER_FOR_PLAYBACK_MS = 100; //jjustman-2020-08-06 - set to 0 1000;

  /**
   * The default duration of media that must be buffered for playback to resume after a rebuffer, in
   * milliseconds. A rebuffer is defined to be caused by buffer depletion rather than a user action.
   */
  public static final int DEFAULT_BUFFER_FOR_PLAYBACK_AFTER_REBUFFER_MS = 100; // jjustman-2020-08-06 //1000;
...
2020-08-06 00:58:17.695 10351-10487/org.ngbp.libatsc3 W/AudioTimestampPoller: reset with updateState(STATE_INITIALZING)
  ...
  public static final int DEFAULT_BACK_BUFFER_DURATION_MS = 500; // ~6 frames?
